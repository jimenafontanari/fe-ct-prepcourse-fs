...
function mayuscula(nombre) {
   ...
   // Debe devolver el mismo nombre, pero con la primera letra en mayúscula.//toUpper... pone mayuscula en la primera y slice corta desde donde quiero a donde quiero.
   // [Ejemplo]: "mario" ----> "Mario".
   // Tu código:
